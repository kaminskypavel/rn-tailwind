...
import com.kaminskypavel.app.generated.BasePackageList;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.kaminskypavel.app.ReactNativeFlipper");
        aClass
